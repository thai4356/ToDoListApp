...
-- 2b) TEAM MEMBERS (nhiều-nhiều user<->team)
...
CREATE TABLE IF NOT EXISTS tasks (
  id            BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
  team_id       BIGINT UNSIGNED NULL,         -- task thuộc team nào
  creator_id    BIGINT UNSIGNED NOT NULL,     -- người tạo
  assignee_id   BIGINT UNSIGNED NULL,         -- người được giao
